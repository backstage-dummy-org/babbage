...
public class DataHelpersTest extends TestCase {
    ...
    public void testDataHelpers_resolveTaxonomy() throws Exception {
        ...
        ContentResponse mockCR = mock(ContentResponse.class);
        CharSequence mockCH = mock(CharSequence.class);
        java.io.InputStream mockIS = mock(java.io.InputStream.class);
...
//        build options
        ...
        when(mockCR.getDataStream()).thenReturn(inputStream);

        Map<String, Object> mapData = toMap(inputStream);
    ...
    private static ObjectMapper objectMapper() {
        return new ObjectMapper().configure(com.fasterxml.jackson.databind.DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false).setSerializationInclusion(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_NULL);
    }

    private static com.fasterxml.jackson.core.type.TypeReference<java.util.LinkedHashMap<String, Object>> mapType() {
        return new com.fasterxml.jackson.core.type.TypeReference<java.util.LinkedHashMap<String, Object>>() {
        };
    }
        ...
        private static void assign(Options options, Object data) {
            ...
            if (org.apache.commons.lang3.StringUtils.isNotEmpty(variableName)) {

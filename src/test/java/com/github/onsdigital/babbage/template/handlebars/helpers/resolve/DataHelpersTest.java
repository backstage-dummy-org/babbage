...
//        build options
        ...
        try {
            ...
            map = mapper.readValue(original, java.util.Map.class);
        ...
        com.fasterxml.jackson.core.type.TypeReference<java.util.LinkedHashMap<java.lang.String, java.lang.Object>> typeReference = new com.fasterxml.jackson.core.type.TypeReference<java.util.LinkedHashMap<java.lang.String, java.lang.Object>>() { };
        when(mockJU.fromJson(inputStream,java.util.LinkedHashMap.class)).thenReturn((java.util.LinkedHashMap) map);
